    ...
    <div id="app">
        <div class="container">
            ...
            <div style="margin-top:20px;" class="jumbotron">
                <div class="container">
                    <h1>Basic Vue JS 2 Starter With Laravel 5.5 </h1>
                    <p>
                      A simple starter template for VueJS 2.0 with Laravel 5.5.<br/>
        ...
        <footer align="center">
            <p>Created by <a href="http://github.com/ayrokid">ayrokid</a>. All Rights Reserved</p>
        </footer>
    </div>{{-- /container --}}
